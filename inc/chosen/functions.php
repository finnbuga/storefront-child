...
function storefront_child_chosen_load_styles_and_scripts() {
	...
	wp_enqueue_script( 'chosen', get_stylesheet_directory_uri() . '/inc/chosen/vendor/chosen/chosen.jquery.js', array( 'jquery' ), '20150315', true );
	...
	wp_enqueue_script( 'storefront-child-chosen', get_stylesheet_directory_uri() . '/inc/chosen/chosen.js', array( 'chosen' ), '20150315', true );
}
